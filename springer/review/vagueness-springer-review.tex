...
\begin{itemize}
\item Perhaps the paper could be revised to present and interpret\marginnote{I agree, I think we should remove this experiment and present three experiments only} the second experiment only, treating the first as a pilot that revealed some issues that were resolved by the main experiment?
\end{itemize}
