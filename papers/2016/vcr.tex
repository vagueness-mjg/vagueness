...
\authornote{Contact author is Matt Green mjglab@gmail.com} % The Author Note, containing contact information, acknowledgements, etc.
\note{\date{\today~\currenttime}} % Notation of manuscript date or other information de- sired beneath affiliation line
\journal{Aimed at Language, Cognition, and Neuroscience} % typeset in the top left header of page 1 (jou and doc modes only)
\volume{volume info} % Volume, number, pages; typeset in the top left header in jou and doc modes, underneath the content of \journal
\ccoppy{Copyright notice etc} % Copyright notice, etc.; typeset in the top right header of page 1 (jou and doc modes only)
\copnum{Additional text} % Any additional text needed;  typeset in the top right header in jou and doc modes, underneath the content of \ccoppy
