## ---- "libs and functions", echo=FALSE, message=FALSE--------------------
library(knitr)
library(tidyverse)
library(broom)
library(broom.mixed)
...
## ---- "EXP_E_Borderline_response_distribution_plot", fig.width=7, fig.height=3, echo=FALSE----
