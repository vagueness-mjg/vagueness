...
The variables are:
Vagueness 2 levels (X) sumcoded -.5, +.5 
Item 4 levels (Y) 
...
Convert a K level factor Y into a sum-coding representation.
...
null.model <- lmer(RT_log ~ 
                     ...
                     Item3 + c_Vag:Item3 + 
                     c_Sel + c_Vag:c_Sel + 
                     (1 + c_Vag * c_Itm * c_Sel|Subject), dat_model, REML=FALSE)
