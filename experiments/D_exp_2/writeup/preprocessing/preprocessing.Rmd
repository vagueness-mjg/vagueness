...
dat <- subset(dat, 
              ...
              select=c(Subject,Item,id,Trial,Vagueness,Selection, Order, Quantity, Instruction, nchar_instr, RT, RT_raw, RT_log, RTprev_log, RTprev_raw, rt_instr, response_cat ))
