...
```{r interactionEffects, message=FALSE, results='hide', echo=FALSE}
load("dd.Rda")
...
```{r plorMainsa, fig.width=16, fig.height=6, warning=FALSE}
...
```{r mainC, fig.width=9, fig.height=3}
# plot main effects
...
```{r foo,fig.width=10, fig.height=3}
...
```{r foo3, fig.width=10,fig.height=5}
...
```{r baayneMplots, fig.width=9, fig.height=3}
