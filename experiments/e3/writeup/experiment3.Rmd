...
# design_info <- unique(subset(dat, select=c(Item, Condition, Vagueness, Selection, Quantity, Order, 
...
# dat <- subset(dat, 
#               select = c(id, Subject, Trial, Condition, Order, Quantity, Vagueness, Selection, 
#                          Item, item_range_ratio, item_range_ratio_scaled, item_mean_ratio, item_mean_ratio_scaled,
#                          c_Trl, s_Trl, c_Itm, c_Vag, Selection.sum, f_Cnd, c_Ord, c_Qty,
